  ...
  const [accordionItems, setAccordionItems] = useState([
    {
      ...
      content:
        <>
          <SubSummary>
            <SubSummaryItem><span style={{ color: "#CCCCCC" }}>프로젝트 기간  </span> &nbsp; 2023.03 - 2023.06</SubSummaryItem>
            <SubSummaryItem><span style={{ color: "#CCCCCC" }}>개발 환경  </span> &nbsp; React</SubSummaryItem>
            <SubSummaryItem><span style={{ color: "#CCCCCC" }}>개발 도구  </span> &nbsp; Visual Studio Code, npm</SubSummaryItem>
            <SubSummaryItem><span style={{ color: "#CCCCCC" }}>기타 사용 모듈  </span> &nbsp; axios, cheerio</SubSummaryItem>
            <SubSummaryItem><span style={{ color: "#CCCCCC" }}>API  </span> &nbsp; 네이버 검색 API, Chat gpt 3.5 API</SubSummaryItem>
